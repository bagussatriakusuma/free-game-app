...
class PopularMobaGameAdapter(private val onClick: OnClickListener): RecyclerView.Adapter<PopularMobaGameAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PopularMobaGameAdapter.ViewHolder {
        val inflate = LayoutInflater.from(parent.context)
        return ViewHolder(ListItemGamesBinding.inflate(inflate,parent,false))
    }

    override fun onBindViewHolder(holder: PopularMobaGameAdapter.ViewHolder, position: Int) {
