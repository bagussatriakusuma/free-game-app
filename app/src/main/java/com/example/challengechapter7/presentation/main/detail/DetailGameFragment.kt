...
import com.example.challengechapter7.common.convertDate
import com.example.challengechapter7.databinding.FragmentDetailGameBinding
import com.example.challengechapter7.presentation.main.bookmark.BookmarkFragment
import com.example.challengechapter7.presentation.main.detail.adapter.ScreenshotsAdapter
import com.example.challengechapter7.presentation.main.home.HomeFragment
...
class DetailGameFragment : Fragment() {
    ...
    private fun handleShowGameDetails(getDetailGameResponse: DetailGames?) {
        Glide.with(requireContext())
